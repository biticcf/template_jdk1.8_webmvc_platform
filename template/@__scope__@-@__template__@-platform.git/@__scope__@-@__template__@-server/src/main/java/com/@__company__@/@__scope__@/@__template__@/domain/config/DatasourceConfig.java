 ...
 * 
 */
package com.@__company__@.@__scope__@.@__template__@.domain.config;
 ...
 */
@Configuration
@MapperScan(basePackages = {"${mybatis.type-dao-package:com.@__company__@.@__scope__@.@__template__@.domain.dao}"}, 
